...
public class ActivityLogController {
    ...
    public ResponseEntity<?> createInteraction(@org.springframework.web.bind.annotation.RequestBody com.MD.CRM.dto.CreateInteractionRequestDTO req) {
        try {
            activityLogService.createInteractionByEmails(req.getCustomerEmail(), req.getUserEmail(), req.getAction(), req.getDescription());
            return ResponseEntity.status(HttpStatus.CREATED).body(java.util.Map.of("success", true));
        } catch (IllegalArgumentException e) {
            return ResponseEntity.badRequest().body(java.util.Map.of("success", false, "message", e.getMessage()));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(java.util.Map.of("success", false, "message", e.getMessage()));
        }
    }
